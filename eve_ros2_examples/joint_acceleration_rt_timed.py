...
jn = JointName.RIGHT_ELBOW_PITCH;
...
class WholeBodyCommandPublisher(Node):
    ...
    def whole_body_state_cb(self, msg):
        ...
        Returns: None
        """
        diff = msg.joint_states[jn].desiredEffort - msg.joint_states[jn].measuredEffort
        # self.get_logger().info("Received whole_body_state, difference between desired and actual force is: {0}".format(str(diff)))
