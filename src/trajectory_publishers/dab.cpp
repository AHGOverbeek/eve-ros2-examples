...
class DabPublisher : public rclcpp::Node {
 public:
  DabPublisher() : Node("dab_trajectory_publisher") {
    ...
    subscription_ = this->create_subscription<action_msgs::msg::GoalStatus>("/eve/whole_body_trajectory_status", 10,
                                                                            std::bind(&DabPublisher::statusCallback, this, _1));
 ...
 private:
  ...
  void publishTrajectory(unique_identifier_msgs::msg::UUID uuid_msg) {
    ...
    trajectory_msg.trajectory_points.push_back(target1(1));
    trajectory_msg.trajectory_points.push_back(target2(2));
    trajectory_msg.trajectory_points.push_back(target2(5));
  ...
  */
  WholeBodyTrajectoryPoint target1(int32_t t) {
    ...
    ret_msg.joint_space_commands.push_back(generateJointSpaceCommand(JointName::RIGHT_SHOULDER_PITCH, -0));
    ret_msg.joint_space_commands.push_back(generateJointSpaceCommand(JointName::RIGHT_SHOULDER_ROLL, -0));
    ret_msg.joint_space_commands.push_back(generateJointSpaceCommand(JointName::LEFT_SHOULDER_ROLL, -0));
    ret_msg.joint_space_commands.push_back(generateJointSpaceCommand(JointName::RIGHT_SHOULDER_YAW, -0));
    ret_msg.joint_space_commands.push_back(generateJointSpaceCommand(JointName::RIGHT_ELBOW_PITCH, -0));
    ret_msg.joint_space_commands.push_back(generateJointSpaceCommand(JointName::RIGHT_ELBOW_YAW, -0));
    ret_msg.joint_space_commands.push_back(generateJointSpaceCommand(JointName::RIGHT_WRIST_PITCH, -0));
    ret_msg.joint_space_commands.push_back(generateJointSpaceCommand(JointName::NECK_PITCH, 0));
    return ret_msg;
  }
  ...
  WholeBodyTrajectoryPoint target2(int32_t t) {
    ...
    ret_msg.joint_space_commands.push_back(generateJointSpaceCommand(JointName::RIGHT_SHOULDER_PITCH, -0));
    ret_msg.joint_space_commands.push_back(generateJointSpaceCommand(JointName::RIGHT_SHOULDER_ROLL, -2));
    ret_msg.joint_space_commands.push_back(generateJointSpaceCommand(JointName::LEFT_SHOULDER_ROLL, +2));
    ret_msg.joint_space_commands.push_back(generateJointSpaceCommand(JointName::RIGHT_SHOULDER_YAW, -0));
    ret_msg.joint_space_commands.push_back(generateJointSpaceCommand(JointName::RIGHT_ELBOW_PITCH, -2));
    ret_msg.joint_space_commands.push_back(generateJointSpaceCommand(JointName::RIGHT_ELBOW_YAW, -0));
    ret_msg.joint_space_commands.push_back(generateJointSpaceCommand(JointName::RIGHT_WRIST_PITCH, -0));
    ret_msg.joint_space_commands.push_back(generateJointSpaceCommand(JointName::NECK_PITCH, 0.5));
    return ret_msg;
  }
...
int main(int argc, char* argv[]) {
  ...
  rclcpp::spin(std::make_shared<eve_ros2_examples::DabPublisher>());
  rclcpp::shutdown();
  return 0;
}
